			...
			<div class="mdl-layout__header-row" style="background: #000000;">
				...
				<nav class="sidebar-container">
					<section class="sidebar-menu">
						...
						<figure class="image-holder">
							...
							<figcaption id="loginUser"
								style="text-align: center; color: white; font-weight: bold; text-transform:capitalize;">
					...
					: session.getAttribute("firstName") + " " + session.getAttribute("lastName")%>
						...
						<ul class="list-group">
							<li class="list-group-item"><a class="" id="admindashboard"
								href="./adminDashboard.jsp">Dashboard</a></li>
							<li class="list-group-item"><a class="" id="influencer"
								href="./influencerSales.jsp">Influencer Sales</a></li>
							<li class="list-group-item"><a class="" id="merchant"
								href="./merchantSales.jsp">Merchant Sales</a></li>
							<li class="list-group-item hidden"><a class="hidden"
								id="editorchoice" href="./editorsChoice.jsp">Editor's Choice</a></li>
							<li class="list-group-item hidden"><a class="hidden"
								id="shoppage" href="./shopPageCuration.jsp">Shop Page
									Curations</a></li>
							<li class="list-group-item"><a class="" id="employee"
								href="./employeeManagement.jsp">Employee Management</a></li>
							<li class="list-group-item"><a class="" id="accountsettings"
								href="./adminAccountSettings.jsp">Account Settings</a></li>
